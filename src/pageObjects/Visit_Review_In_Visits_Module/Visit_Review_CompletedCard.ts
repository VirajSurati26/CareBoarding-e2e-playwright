...
export class CompletedCard extends BasePage {
    ...
    //Click on the "Completed visit" card in Visit review page
    async Click_CompletedVisitcard() {
        await this.page.getByText('CompletedVisit', { exact: true }).click();
