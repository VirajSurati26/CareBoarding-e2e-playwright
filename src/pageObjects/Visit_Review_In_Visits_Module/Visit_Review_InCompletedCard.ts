...
export class InCompletedCard extends BasePage {
    ...
    async ClickVisitReviewOption() {
      ...
      //------------------InCompleted visit" card-----------------------

    //Click on the "In-Completed visit" card in Visit review page
    async Click_InCompletedVisitcard() {
        await this.page.getByText('InCompletedVisit', { exact: true }).click();
